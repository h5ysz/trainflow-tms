// GCCLAB TMS — Seed the bilingual question bank for "First Aid" (FA-001)
// =====================================================================
// Source: First Aid question content from CSCC22 seed, targeting the
// existing FA-001 core mandatory course.
// Does NOT create a new course — only finds existing FA-001 by code.
...
async function run() {
  ...
  console.log("=== SEED FA-001 FIRST AID QUESTIONS COMPLETE ===");
