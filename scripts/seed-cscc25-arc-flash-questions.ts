// GCCLAB TMS — Seed the bilingual question bank for "Arc Flash Awareness" (CSCC25)
// =====================================================================
// Source: Distribution Safety Rules, Safe Isolation & Switching Procedures (CSCC25 arc flash lessons).
...
const COURSE_CODE = "CSCC25";
const COURSE_TITLE = "Arc Flash Awareness";
const COURSE_TITLE_AR = "التوعية بمخاطر وميض القوس الكهربائي";
...
const IMG = {
  headProtection: "/question-images/cscc25/figure-2-1-head-protection.png",
  eyeProtection: "/question-images/cscc25/figure-2-2-eye-protection.png",
  arcFlashBoundaryPpe: "/question-images/cscc25/figure-2-4-arc-flash-boundary-ppe.png",
  arcRatedClothing: "/question-images/cscc25/figure-2-5-arc-rated-clothing.png",
  arcFlash: "/question-images/cscc25/figure-1-3-arc-flash.png",
  arcFireExplosion: "/question-images/cscc25/figure-1-4-arc-fire-explosion.png",
  stepPotential: "/question-images/cscc25/figure-1-6-step-potential.png",
  touchPotential: "/question-images/cscc25/figure-1-7-touch-potential.png",
  exposedParts: "/question-images/cscc25/figure-1-16-exposed-parts-hazard.png",
  defectiveInsulation: "/question-images/cscc25/figure-1-17-defective-insulation.png",
  overheadLine: "/question-images/cscc25/figure-1-18-overhead-line-hazard.png",
  overload: "/question-images/cscc25/figure-1-19-overload-hazard.png",
  extensionCord: "/question-images/cscc25/figure-1-22-extension-cord.png",
  damagedInsulation: "/question-images/cscc25/figure-9-13-damaged-insulation.png",
  dangerSign: "/question-images/cscc25/figure-6-1-danger-sign.png",
  warningSign: "/question-images/cscc25/figure-6-2-warning-sign.png",
  fireSafetySigns: "/question-images/cscc25/figure-6-6-fire-safety-signs.png",
  hvTestBarriers: "/question-images/cscc25/figure-8-15-hv-test-barriers.png",
  securityLocks: "/question-images/cscc25/figure-9-4-security-locks.png",
  safetyLocks: "/question-images/cscc25/figure-9-5-safety-locks.png",
  isolationCard: "/question-images/cscc25/figure-9-1-isolation-card.png",
  grounding: "/question-images/cscc25/figure-7-2-grounding-connections.png",
  groundResistance: "/question-images/cscc25/figure-5-8-ground-resistance-table.png",
};
...
const QUESTIONS: SeedQuestion[] = [
  {
    type: "SINGLE_CHOICE",
    testType: "PRE_TEST",
    text: "What is an arc flash?",
    textAr: "ما هو وميض القوس الكهربائي؟",
    options: [
      "An electric current that ionizes the surrounding air and creates an arc with intense heat and light",
      "A normal spark seen on switches",
      "The light of a lamp",
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "PRE_TEST",
    text: "Eye protection must be worn whenever there is danger of injury from:",
    textAr: "يجب ارتداء حماية العينين كلما وُجد خطر الإصابة من:",
    options: [
      "Electric arcs, flashes, or flying objects from an electrical explosion",
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "PRE_TEST",
    text: "What does the threshold incident energy level for a second degree burn equal?",
    textAr: "ما هي قيمة مستوى الطاقة الحادثة الحدية لحروق الدرجة الثانية؟",
    options: ["5 J/cm²", "1.2 cal/cm²", "0.5 cal/cm²", "2.0 cal/cm²"],
    correctAnswers: [0],
    difficulty: "HARD",
  },
  {
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "PRE_TEST",
    text: "Arc-rated clothing must be worn where exposure to an arc flash above the threshold level is possible because it:",
  ...
  },
  {
    type: "TRUE_FALSE",
    testType: "PRE_TEST",
    text: "An arc flash can cause fire, explosion, and severe injury or death.",
    textAr: "يمكن أن يسبب وميض القوس الكهربائي حريقاً وانفجاراً وإصابات خطيرة أو الوفاة.",
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "Arc flash hazards are most dangerous when working:",
    textAr: "تكون مخاطر وميض القوس الكهربائي أخطر عند العمل:",
    options: [
      "On or near energized electrical conductors and equipment",
      "In the parking lot",
      "In the cafeteria",
      "At a desk",
    ],
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "When handling tools near energized conductors, the worker must always be aware of:",
    textAr: "عند التعامل مع الأدوات بالقرب من الموصلات الكهربائية النشطة، يجب أن يكون العامل دائماً على دراية بـ:",
    options: [
      "The arcing hazard",
      "The wind direction",
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "Wires and parts that are exposed or have damaged insulation are an electrical hazard because they:",
    textAr: "الأسلاك والأجزاء المكشوفة أو ذات العزل التالف تمثل خطراً كهربائياً لأنها:",
    options: [
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "Overhead power lines are usually:",
    textAr: "خطوط الطاقة العلوية عادةً تكون:",
    options: [
      "Not insulated",
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "What is the maximum recommended ground resistance for most installations?",
    textAr: "ما هي القيمة القصوى الموصى بها لمقاومة الأرض لمعظم التركيبات؟",
    options: [
  ...
  },
  {
    type: "TRUE_FALSE",
    testType: "FINAL_TEST",
    text: "Insulating equipment must be inspected for damage daily before use.",
    textAr: "يجب فحص المعدات العازلة بحثاً عن التلف يومياً قبل الاستخدام.",
    options: TRUE_FALSE_OPTIONS,
    correctAnswers: [0],
    difficulty: "EASY",
  },
  ...
  },
  {
    type: "TRUE_FALSE",
    testType: "FINAL_TEST",
    text: "Only qualified and authorized personnel may perform work on energized equipment.",
    textAr: "فقط الأفراد المؤهلون والمصرح لهم يمكنهم أداء العمل على المعدات النشطة.",
    options: TRUE_FALSE_OPTIONS,
    correctAnswers: [0],
    difficulty: "EASY",
  },
  ...
  },
  {
    type: "SINGLE_CHOICE",
    testType: "FINAL_TEST",
    text: "The greatest danger from an arc flash to nearby workers is:",
    textAr: "أخطر ما في وميض القوس الكهربائي على العمال القريبين هو:",
    options: [
      "Severe burns, hearing damage, and eye injury from intense heat, light, and sound",
      "A slight increase in room temperature",
      "Minor noise",
      "Change in the smell of the air",
    ],
    correctAnswers: [0],
    difficulty: "MEDIUM",
    imageUrl: IMG.arcFlashBoundaryPpe,
...
async function run() {
  ...
  console.log("=== SEED CSCC25 ARC FLASH QUESTIONS COMPLETE ===");
