      ...
      >
        <div className="space-y-5">
          ...
          <div className="border-t pt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
            <label className="flex items-center gap-2 text-sm"><Switch checked={(formData.hasPreTest as boolean) ?? false} onCheckedChange={(v) => setField("hasPreTest", v)} /> {t("courses.hasPreTest")}</label>
            <label className="flex items-center gap-2 text-sm"><Switch checked={(formData.hasFinalTest as boolean) ?? false} onCheckedChange={(v) => setField("hasFinalTest", v)} /> {t("courses.hasFinalTest")}</label>
            <label className="flex items-center gap-2 text-sm"><Switch checked={(formData.hasEvaluation as boolean) ?? false} onCheckedChange={(v) => setField("hasEvaluation", v)} /> {t("courses.hasEvaluation")}</label>
          </div>
        </div>
      </FormDialog>
