      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-6">
        <Card className="max-w-md w-full p-8 text-center">
          <div className="flex justify-center mb-4">
            <Image src="/gcclab-icon.png" alt="GCC Lab" width={56} height={56} className="rounded-xl" />
          </div>
          <div className="flex justify-center mb-4">
      ...
      <div className="hidden lg:flex lg:flex-1 flex-col justify-between p-12 xl:p-16 bg-primary text-primary-foreground relative overflow-hidden tf-industrial-bg">
        <div className="relative z-10">
          <Image
            ...
            priority
          />
          <div className="mt-2 text-xs text-primary-foreground/70 font-medium">
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12 bg-background overflow-y-auto">
        <div className="w-full max-w-sm space-y-5 py-8">
          ...
          <div className="flex lg:hidden items-center gap-3 mb-6">
            <Image src="/gcclab-icon.png" alt="GCC Lab" width={44} height={44} className="rounded-lg" />
            <div>
              <div className="text-lg font-bold tracking-tight">{locale === "en" ? "GCC Lab" : "المختبر الخليجي"}</div>
