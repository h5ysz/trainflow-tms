...
// =====================================================================
// Course materials are external (PowerPoint, PDF, URL, QR link). GCCLAB does
// NOT store the actual content — only pointers to external URLs.
//
// GET   — list all active resources for a course (any authenticated user)
