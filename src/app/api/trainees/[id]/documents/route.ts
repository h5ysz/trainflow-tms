...
//
// Supports photo + five document types (Iqama, ID, Passport, Certificate,
// OHS) plus an "other" catch-all. Files are stored on disk under
...
//     formData: file=..., type=photo|iqama|id|passport|certificate|ohs|other
...
const VALID_TYPES = ["photo", "iqama", "id", "passport", "certificate", "ohs", "other"] as const;
